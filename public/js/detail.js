			...
			if(!loginresult.havelogan) {
				...
				$.ajax({
					...
					success: function(info) {
						...
						$.ajax({
							url: 'http://tdye123.picp.net:12757/query/docdetail',
							type: 'get',
							dataType: 'json',
							data: `id=${id}`,
							success: function(result) {
								...
								$('#download').click(function() {
									var xhr = new XMLHttpRequest();
										xhr.open("GET", "http://tdye123.picp.net:12757" + dataset[4].path, true);
									...
									$.ajax({
										url: 'http://tdye123.picp.net:12757/update/point_opr',
										type: 'post',
										dataType: 'json',
										data: post_data,
