...
$(function() {
                        ...
                        success: function(result) {
                            ...
                            $('#submit_file_btn').click(function() {
                                ...
                                if($.trim(document_name)==''||$.trim(document_description)==''||!file_data) {
                                    ...
                                    xhr.open('post','http://tdye123.picp.net:12757/upload',true);
                            ...
                            $('#old-password').focusout(function() {
                                ...
                                $.ajax({
                                    url: `http://tdye123.picp.net:12757/check/password`,
                                    type: 'post',
                                    dataType: 'json',
                                    data: data,
                            ...
                            $('#change_password_Btn').click(function() {
                                if($('#new-password').val() === $('#old-password').val()) {
                                    ...
                                    $.ajax({
                                        url: 'http://tdye123.picp.net:12757/update/password',
                                        type: 'post',
                                        dataType: 'json',
                                        data: passwordData,
                                        success: function(result1) {
                                            if(result1.state === 'success') {                                
                                                $.ajax({
                                                    url: 'http://tdye123.picp.net:12757/logout',
                                                    type: 'get',
                                                    dataType: 'json',
                                                    data: '',
                            ...
                            $('#pointrecord').click(function() {
                                $.ajax({
                                    url: 'http://tdye123.picp.net:12757/query/pointrecord',
                                    type: 'get',
                                    dataType: 'json',
                            ...
                            $('#uploadrecord').click(function() {
                                $.ajax({
                                    url: 'http://tdye123.picp.net:12757/query/uploadrecord',
                                    type: 'get',
                                    dataType: 'json',
                                    data: `username=${result.username}`,
                            ...
                            $('#submit').click(function() {
                                ...
                                if($('#_username').val()&&$('#_sno').val()&&$('#_email').val()&&$('#_tel').val()) {
                                    ...
                                    $.ajax({
                                        url: 'http://tdye123.picp.net:12757/update/info',
                                        type: 'post',
                                        dataType: 'json',
                                        data: new_info,
                                        success: function(result) {
                            ...
                            $('#follow').click(function() {
                                ...
                                $.ajax({
                                    url: 'http://tdye123.picp.net:12757/query/follow',
                                    type: 'get',
                                    dataType: 'json',
                                    data: `username=${result.username}`,
    ...
    $('#_username').focusout(function() {
        ...
        if(username.length === 0 ) {
            ...
            $.ajax({
                url: `http://tdye123.picp.net:12757/check/name`,
                type: 'get',
...
function dynamicAddDocument(list) {
    for (var i = 0; i < list.length; i++)
    {
        ...
        DCancel.onclick = function() {
            $.ajax({
                url: 'http://tdye123.picp.net:12757/update/delete',
                type: 'get',
                dataType: 'json',
                data: `id=${this.id}`,
                success: function(result) {
...
function dynamicAddOtherUsers(userlist, myusername) {
    for (var i = 0; i < userlist.length; i++) {
        ...
        UCancel.onclick = function() {
            ...
            $.ajax({
                url: 'http://tdye123.picp.net:12757/update/unfollow',
                type: 'post',
                dataType: 'json',
                data: postdata,
                success: function(result) {
